"""
Consulta de Inadimplência — página separada do Dashboard.

Rodar com:
    streamlit run app.py
(esta página aparece sozinha na navegação da barra lateral)
"""
...
st.set_page_config(
    page_title="Consulta de Inadimplência",
    page_icon="🔎",
    layout="wide",
    initial_sidebar_state="expanded",
)

# Mesma senha do Dashboard — se a pessoa já entrou na outra página nesta
# sessão do navegador, não precisa digitar de novo (fica em session_state).
