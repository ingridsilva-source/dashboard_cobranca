"""
Conteúdo da página "Dashboard - Carteira de Cobrança" — filtros globais
por mês e por carteira, KPIs e gráficos. A senha e o page_config ficam
em app.py (o roteador da navegação); este arquivo assume que quem
